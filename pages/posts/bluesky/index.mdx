...
import coulombs_law from "./coulombs_law.svg";
import dipole from "./dipole.svg";
import dipole_approximation from "./dipole_approximation.svg";
import dipole_radiation from "./dipole_radiation.png";
import power_wavelength from "./power_wavelength.png";
...
<Image src={coulombs_law} alt="Coulomb's Law" />
...
most of the time we take that constant so that $\lim\_{r \to \infty} V = 0$.
...
<Image src={dipole_approximation} alt="Dipole Approximation" />
...
Okay, now let's compute the electric field where $\vec{e\_\theta}$ is $\vec{e_r}$ rotated
...
<Image src={dipole_radiation} alt="Dipole Radiation Graph" />
...
<Image src={power_wavelength} alt="Power vs Wavelength" />
