export const metadata = {
  ...
  updated: "12-03-2022",
  summary:
    "Have you ever wondered how the cool rotating tesseract projections are made ?" +
...
that $R*{\alpha t} \in SO(2)$ and $R*{\beta t} \in SO(2)$:
...
Also, $|R| = |R*{\alpha t}||R*{\beta t}| = 1$ <br/> $\alpha$ and $\beta$ represent,
...
[3]: https://github.com/devspaceship/science-decoder/tree/master/components/tesseract

<!-- TODO Create tesseract component with three.js -->