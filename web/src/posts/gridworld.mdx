...
If there is a wall, we get a 'reward' of $r_1 = -100$.
If there is nothing, we get a reward of $r_1 = -1$, and if we got to the end, we get a reward of $+100$ and the game ends $r_1 = 100$.
