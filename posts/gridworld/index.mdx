...
updated: "2022-03-12"
summary:
  An easy introduction to Markov Decision Processes and Reinforcement Learning by the mean of a gridworld environement
...
import MDP from "./MDP.svg";
import policy_iteration from "./policy_iteration.svg";
import value_iteration from "./value_iteration.svg";
...
You can move the starting and ending point by draging them.
Traps have been placed and are represented by red cells.
You can place others by clicking or initiating a drag on an empty cell.
Similarly, you can remove traps by clicking or initiating a drag on a trap cell.
...
<Image src={MDP} alt="Finite Deterministic Markov Decision Process" />
...
<Image src={policy_iteration} alt="Policy Iteration" />
...
<Image src={value_iteration} alt="Value Iteration" />
